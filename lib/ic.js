...
var IC = /** @class */ (function () {
    function IC() {
        var _this = this;
        this._subnets = Array();
        this.crawler = { enableExport: false, outputDir: '' };
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = output.entries; _i < _a.length; _i++) {
                            value = _a[_i];
                            subnet = new subnet_1.default(principal_1.Principal.fromUint8Array(value.subnetId.principalId.raw).toText());
                            subnet.assignCanisterRange(value.range.startCanisterId.principalId.raw, value.range.endCanisterId.principalId.raw);
        ...
        this.printSubnets = function () {
            _this._subnets.forEach(function (subnet) {
                console.log(subnet.getNodeIdAsString());
            });
        };
        this.printNetwork = function () { return __awaiter(_this, void 0, void 0, function () {
            var tmp;
            return __generator(this, function (_a) {
                tmp = this.exportObject();
        ...
        this.exportNetworkInfoToFile = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        this.writeToFile(JSON.stringify(data), this.crawler.outputDir, '_info.txt');
                        return [2 /*return*/];
                }
            });
        }); };
        this.exportSubnetToFile = function (s) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.crawler.enableExport) return [3 /*break*/, 3];
                        return [4 /*yield*/, s.exportObject()];
                    case 1:
                        data = _a.sent();
                        dataString = JSON.stringify(data);
                        fileName = s.getNodeIdAsString() + '.txt';
                        return [4 /*yield*/, this.writeToFile(dataString, this.crawler.outputDir, fileName)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
        ...
        this.initializeExport = function () {
            _this.crawler.enableExport = true;
            _this.crawler.outputDir = path_1.default.join(EXPORT_DIR, utils_1.getCurrentDate());
        };
        ...
        this.runCrawler = function (enableExport) {
            if (enableExport === void 0) { enableExport = false; }
    ...
    //     extendProtobuf(cm, root.lookupService('CyclesMinting'));
    //     const totalSupply = await cm.total_cycles_minted({});
    //     console.log('totalSupply:', totalSupply.value);
    // };
    IC.prototype.exportObject = function (includeCanisters) {
