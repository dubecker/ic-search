            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        options = Object.assign(Object.assign({}, options), (_b = (_a = actor[metadataSymbol].config).queryTransform) ===
                            null || _b === void 0
                            ? void 0
                        ...
                        return [4 /*yield*/, agent.query(cid, {
        ...
        caller = function (options, args) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        // First, if there's a config transformation, call it.
                        options = Object.assign(Object.assign({}, options), (_b = (_a = actor[metadataSymbol].config).callTransform) ===
                            null || _b === void 0
                            ? void 0
                            : _b.call(_a, method.name, args, Object.assign(Object.assign({}, actor[metadataSymbol].config), options)));
                        agent = options.agent ||
                    ...
                    case 2:
                        ...
                        if (responseBytes !== undefined) {
                            return [2 /*return*/, retType.decode(responseBytes)];
                        }
                        else if (!retType) {
...
//# sourceMappingURL=agent-pb.js.map