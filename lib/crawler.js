            ...
            return __generator(this, function (_d) {
                ...
                for (_i = 0, _a = this._subnets; _i < _a.length; _i++) {
                    ...
                    if (storedFiles.includes(subnetFile)) {
                        ...
                        subnet.setLatestCanisterId(principal_1.Principal.fromText(subnetStored.subnetInfo.idLatest));
                        ...
                        for (_b = 0, _c = subnetStored.canisters; _b < _c.length; _b++) {
                            c = _c[_b];
                            canister = new canister_1.default(c.id);
                            canister.initialize(c.controller, c.module_hash, c.type, subnet._id);
