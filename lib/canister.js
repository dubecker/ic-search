...
var Canister = /** @class */ (function () {
    function Canister(id) {
        ...
        this.setController = function (controllers) {
        ...
        this.setModuleHash = function (h) {
            _this._module_hash = h;
        };
        this.getModuleHash = function () {
            return _this._module_hash;
        };
        this.setSubnet = function (s) {
            _this._subnet = s;
        };
        this.getSubnet = function () {
            return _this._subnet;
        };
        ...
        this.getCanisterIdAsString = function () {
            // return Principal.fromUint8Array(this._id).toText();
            return _this._id;
        };
        this.isSpecialCanister = function () {
            return underscore_1.default.contains(CANISTER_EXCEPTIONS, _this.getCanisterIdAsString());
        };
        this.fetchCanisterInfo = function (agent) {
        ...
        this.exportObject = function () {
            return {
                id: _this.getCanisterIdAsString(),
                controller: _this.getController(),
                module_hash: _this.getModuleHash(),
                type: _this.getType(),
            };
        };
        // construct with human readable text representation
    ...
    Canister.prototype.getCanisterIdAsBlob = function () {
        // return this._id;
        return candid_1.blobFromUint8Array(principal_1.Principal.fromText(this._id).toUint8Array());
    };
    Canister.incrementCanister = function (canisterId) {
    ...
    Canister.incrementCanisterBy = function (canisterId, incr) {
        for (var i = 0; i < incr; ++i) {
            canisterId = Canister.incrementCanister(canisterId);
        }
        return canisterId;
    };
    Canister.calculateDifference = function (var1, var2) {
        return 0;
    };
    Canister.canisterIdToDecimal = function (val) {
